...
const News_Letter = () => {
  return (
    <div className=' md:px-28 px-3 mt-20'>

        <div className=' py-10 pt-20 bg-custom-gradient px-3 flex flex-col items-center justify-center space-y-5'>
            <p className=' text-3xl md:text-5xl font-semibold'>Get Exclusive Offers On Your Email </p>
